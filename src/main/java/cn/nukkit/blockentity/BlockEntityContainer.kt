 ...
 *
 *
 * `BlockEntityContainer`容器必须包含物品的`Item`对象。<br></br>
...
interface BlockEntityContainer {
	/**
	 * 返回一个存储在容器里的物品的`Item`对象。<br></br>
	 * Returns an item that stores in this container, as an `Item` object.
	 *
	 * @param index 这个物品的索引序号。<br></br>The index number of this item.
	 * @return 这个物品的 `Item`对象。<br></br>An `Item` object for this item.
	 * @since Nukkit 1.0 | Nukkit API 1.0.0
	 */
