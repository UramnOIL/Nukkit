...
class JungleBigTreePopulator @JvmOverloads constructor(private val type: Int = BlockSapling.JUNGLE) : Populator() {
	...
	override fun populate(level: ChunkManager, chunkX: Int, chunkZ: Int, random: NukkitRandom, chunk: FullChunk) {
		...
		for (i in 0 until amount) {
			...
			ObjectJungleBigTree(10, 20, get(BlockID.WOOD, BlockWood.JUNGLE), get(BlockID.LEAVES, BlockLeaves.JUNGLE)).generate(this.level, random, v.setComponents(x.toDouble(), y.toDouble(), z.toDouble()))
		}
	}
