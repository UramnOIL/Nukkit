...
class NoiseGeneratorSimplexD @JvmOverloads constructor(p_i45471_1_: NukkitRandom = NukkitRandom(System.currentTimeMillis())) {
	...
	fun getValue(p_151605_1_: Double, p_151605_3_: Double): Double {
		...
		val d6 = (i + j).toDouble() * d5
		val d7 = i.toDouble() - d6
		val d8 = j.toDouble() - d6
		...
		val d11 = d9 - k.toDouble() + d5
		val d12 = d10 - l.toDouble() + d5
	...
	fun add(p_151606_1_: DoubleArray, p_151606_2_: Double, p_151606_4_: Double, p_151606_6_: Int, p_151606_7_: Int, p_151606_8_: Double, p_151606_10_: Double, p_151606_12_: Double) {
		var i = 0
		for (j in 0 until p_151606_7_) {
			val d0 = (p_151606_4_ + j.toDouble()) * p_151606_10_ + yo
			for (k in 0 until p_151606_6_) {
				val d1 = (p_151606_2_ + k.toDouble()) * p_151606_8_ + xo
				val d5 = (d1 + d0) * F2
				val l = fastFloor(d1 + d5)
				val i1 = fastFloor(d0 + d5)
				val d6 = (l + i1).toDouble() * G2
				val d7 = l.toDouble() - d6
				val d8 = i1.toDouble() - d6
				val d9 = d1 - d7
				val d10 = d0 - d8
				var j1: Int
				var k1: Int
				...
				val d11 = d9 - j1.toDouble() + G2
				val d12 = d10 - k1.toDouble() + G2
	...
	companion object {
		...
		private fun dot(p_151604_0_: IntArray, p_151604_1_: Double, p_151604_3_: Double): Double {
			return p_151604_0_[0].toDouble() * p_151604_1_ + p_151604_0_[1].toDouble() * p_151604_3_
		}
	}
