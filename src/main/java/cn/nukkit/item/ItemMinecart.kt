 ...
 * Nukkit Project
 */
class ItemMinecart @JvmOverloads constructor(meta: Int? = 0, count: Int = 1) : Item(ItemID.Companion.MINECART, meta, count, "Minecart") {
	...
	override fun onActivate(level: Level, player: Player, block: Block, target: Block, face: BlockFace, fx: Double, fy: Double, fz: Double): Boolean {
		if (Rail.isRailBlock(target)) {
			...
			val minecart = Entity.createEntity("MinecartRideable",
